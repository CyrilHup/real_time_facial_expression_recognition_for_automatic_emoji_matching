...
\begin{enumerate}
    \item \textbf{Single model}: Standard operation with one model
    \item \textbf{Comparison mode}: Side-by-side comparison of multiple models
    \item \textbf{Ensemble mode}: Fusion of predictions from multiple models using weighted averaging, voting, or simple averaging
\end{enumerate}
